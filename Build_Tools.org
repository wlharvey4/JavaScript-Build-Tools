...
You get slightly different output from ~npm list~ (show below), but you can
then ~require('mongoose')~ like you would normally.

Upgrading is also easy: just change 4.2.4 to 4.2.7 and run ~npm install~
